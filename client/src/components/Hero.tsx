    ...
    <div className="relative bg-blue-50 overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-blue-600 xl:inline">join our community.</span>
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link href="/resources" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 md:py-4 md:text-lg md:px-10">
                    Learn More
                  </Link>
                </div>
              </div>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        ...
        {/* <div className="h-56 w-full bg-blue-200 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center text-blue-500">
             <span className="text-lg font-medium">Inspiring Image Here</span>
        </div> */}
      </div>
    </div>
  );
